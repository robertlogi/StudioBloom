    ...
    <>
      <section className="bg-[#f3f0eb] py-20 md:py-28">
        <div className="container mx-auto px-4 max-w-6xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl text-[#2c3e2d] text-center animate-fade-in">Hafa samband við okkur</h1>
        </div>
      </section>
      ...
      <section className="section-spacing">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-16">
            ...
            >
              <h2 className="text-3xl md:text-4xl text-[#2c3e2d] mb-8">Upplýsingar um Studio Bloom</h2>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Hafa samband",
                "item": `${SITE_CONFIG.url}/hafa-samband`
              }
            ]
          })
        }}
